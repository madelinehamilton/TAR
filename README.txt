...
2. Go into /changepoint_detection/ directory and run python_changepoint_analysis.py, R_changepoint_analysis.R, tally_changepoints.py, visualize_changepoint_tallies.py, time_series_changepoint_visual.R, and time_series_legend.py.
